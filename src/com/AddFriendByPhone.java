...
// TODO: Add javadoc
public class AddFriendByPhone extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_new_friendbyphone);
    ...
    public void onClick(View view) {
        if (view == mCancelButton) {
			...
			if(mImService.isConnectedToInternet(AddFriendByPhone.this.getApplicationContext())) {
			...
			{
				Toast.makeText(AddFriendByPhone.this, "Check internet connection", Toast.LENGTH_LONG).show();
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
		...
		public void onServiceDisconnected(ComponentName className) {
            ...
            Toast.makeText(AddFriendByPhone.this, R.string.local_service_stopped, Toast.LENGTH_SHORT).show();
        }
    };
	...
	protected Dialog onCreateDialog(int id) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddFriendByPhone.this);
...
//        mImService.addNewFriendRequestByEmail(mFriendUserNameText.getText().toString());
          ...
          mImService.addNewFriendRequestByEmail(mFriendUserNameText.getText().toString());      
            ...
            Toast.makeText(AddFriendByPhone.this, R.string.request_sent, Toast.LENGTH_SHORT).show();

            finish();
        } else {
            Log.e(LOG_TAG, "addNewFriend: username length (" + mFriendUserNameText.length() + ") is < 0");
            Toast.makeText(AddFriendByPhone.this, R.string.type_friend_username, Toast.LENGTH_LONG).show();
        }
    }
