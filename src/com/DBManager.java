...
public abstract class DBManager extends SQLiteOpenHelper{
	...
	private static final String DB_FILE_NAME = "CommiceAccount.db";
	...
	public void update(ContentValues values){
		getWritableDatabase().update(tableName, values, null, null);
	}
	
	/// this is not usefull
	public void update2(ContentValues values){
		getWritableDatabase().update(tableName, values, null, null);
	}
	public void update3(ContentValues values){
		getWritableDatabase().update(tableName, values, null, null);
	}
