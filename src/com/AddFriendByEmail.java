...
// TODO: Add javadoc
public class AddFriendByEmail extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_new_friendbyemail);
        ...
        if (mAddFriendButton != null) {
        	...
        	Toast toast = Toast.makeText(getApplicationContext(), "Please Enter The E-Mail You Want To Add", Toast.LENGTH_SHORT);
    ...
    public void onClick(View view) {
        if (view == mCancelButton) {
			...
			if(mImService.isConnectedToInternet(AddFriendByEmail.this.getApplicationContext())) {
			...
			{
				Toast.makeText(AddFriendByEmail.this, "Check internet connection", Toast.LENGTH_LONG).show();
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
		...
		public void onServiceDisconnected(ComponentName className) {
            ...
            Toast.makeText(AddFriendByEmail.this, R.string.local_service_stopped, Toast.LENGTH_SHORT).show();
        }
    };
	...
	protected Dialog onCreateDialog(int id) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddFriendByEmail.this);
...
//        mImService.addNewFriendRequestByEmail(mFriendUserNameText.getText().toString());
          ...
          mImService.addNewFriendRequestByEmail(mFriendUserNameText.getText().toString());      
            ...
            Toast.makeText(AddFriendByEmail.this, R.string.request_sent, Toast.LENGTH_SHORT).show();

            finish();
        } else {
            Log.e(LOG_TAG, "addNewFriend: username length (" + mFriendUserNameText.length() + ") is < 0");
            Toast.makeText(AddFriendByEmail.this, R.string.type_friend_username, Toast.LENGTH_LONG).show();
        }
    }
